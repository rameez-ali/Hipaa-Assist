                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <a href="{{route('trainings.index')}}"><h2 class="mb-0"><i class="fas fa-angle-left"></i> Add Training</h2></a>
                                    ...
                                    <form method="post" action="{{ route('trainings.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                                     @csrf
                                        <div class="row">
                                            <div class="col-lg-6"><input name="training_name" type="text" class="site-input w-100" placeholder="Training Name * " required></div>
                                        </div>
                                        <div class="row mt-1">
                                            <div class="col-lg-6">
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-lg-6"><input name="pass_percentage" type="text" class="site-input w-100" placeholder="Passing Percentage * " required></div>
                                        </div>
                                        <div class="row mt-1">
                                            <div class="col-lg-6"><input name="amount" type="number" class="site-input w-100" placeholder="Training Amount * " required></div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-lg-6">
                                                <p class="grey-text">Image * </p>
                                                    <div class="d-flex">
                                <input style="height:100px;position:absolute;padding: 87px 0px 87px 0px;opacity: 0;" id="image" type="file" name="image" accept="image/*" onchange="readURL(this);" required />
                                <img src="{{asset('images/training-details-2.png')}}" alt="" class="img-fluid">
                                <img style="padding-left:20px;border-style: hidden;" id="modal-preview" class="hidden"  width="220" height="190" alt="">
                        ...
                        <div class="position-relative">
                            ...
                            <span class="rounded-circle cancel-btn border-0 p-0"><i class="fas l-grey-text fa-times-circle"></i></span>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <textarea name="description" id="" cols="30" rows="8" class="site-input w-100" placeholder="Description * " required></textarea>
                                            </div>
                                        </div>
