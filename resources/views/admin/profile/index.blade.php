                                ...
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            @if ($incorrectpasswordsuccess = Session::get('incorrectpasswordsuccess'))
                                            <div style="margin-top:10px;" class="alert alert-success alert-dismissible">
                                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
            ...
            <div class="text-center">
                ...
                @csrf
                    ...
                    <div class="d-sm-flex">
                        ...
                        <div class="form-field w-100 my-1">
                            <input name="confirm_password" type="password" class="site-input w-100 login both-icon enter-input" placeholder="*********" id="confirm-password">
                           <i toggle="#confirm_password" class="fa fa-eye-slash enter-icon right-icon toggle-password" aria-hidden="true"></i>
                        </div>
                    </div>
                    <div class="d-sm-flex">
...
$.get('/hipaa/admin/userregistration/'+customer_id+'/edit', function (data) {
...
jQuery(document).ready(function ()
{
        ...
        jQuery('select[name="category_id"]').on('change',function(){
           ...
           jQuery('select[name="training_id"]').empty();
              jQuery.ajax({
                 url : '/hipaa/admin/userregistration/gettrainingsedit/' +category_id,
                 type : "GET",
                 dataType : "json",
                 success:function(data) {
                     console.log(data);
...
jQuery(document).ready(function ()
{
        ...
        jQuery('select[name="category_id"]').on('change',function(){
           ...
           jQuery('select[name="company_id"]').empty();
              jQuery.ajax({
                 url : '/hipaa/admin/userregistration/getcompaniesedit/' +category_id,
                 type : "GET",
                 dataType : "json",
                 success:function(data) {
                     console.log(data);
