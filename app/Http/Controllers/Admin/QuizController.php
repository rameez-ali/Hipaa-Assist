...
class QuizController extends Controller
{
    ...
    public function index(Request $request, $id)
    {
    	...
    	return view('admin.quizes.index',compact('training_id','question_number','quizes'));
    }
    ...
    public function report($id){
        ...
        $no_of_attempts_againts_training=Quiz::select('question','question_number','correct_answer','training_id')->where('training_id',$id)->get();

 
        
        // $no_of_attempts_againts_training=Quiz_attempt::select('id','training_id','correct_answer','question_number')
        //                                                   ->wherein('question_number',$no_of_question_againts_training)
        //                                                   ->wherein('correct_answer',$no_of_question_againts_training)
        //                                                 ->wherein('training_id',$no_of_question_againts_training)
        //                                                 ->get();
        return view('admin.quizes.report',compact('no_of_attempts_againts_training'));
