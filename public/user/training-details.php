            ...
            <div class="container text-center text-lg-left">
                <div class="pb-5">
                    <div class="d-sm-flex justify-content-between align-items-center">
                        <a href="my-trainings.php"><h5 class="mb-0 mt-2"><i class="fas fa-angle-left"></i> Business Trainings</h5></a>
                    ...
                    <a href="training-view.php" class="site-btn d-inline-block px-5 mt-5 py-2">View</a>
                </div>
            </div>
        </section>
