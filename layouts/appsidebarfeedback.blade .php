...
<div class="main-menu menu-fixed menu-light menu-accordion" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item "><a href="user-registration.php"><i
            ...
            <li class="nav-item <?php if ("feedback") {echo "active"; } else  {echo "";}?>"><a href="{{route('feedback.index')}}" class="d-flex"><i class="custom-icon"><svg width="18.173" height="18.173" viewBox="0 0 18.173 18.173">
